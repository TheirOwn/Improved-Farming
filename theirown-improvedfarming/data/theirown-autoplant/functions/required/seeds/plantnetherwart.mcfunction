...
execute as @s at @s if score @s itemage < planttime itemage run particle minecraft:falling_dust minecraft:soul_sand ~ ~ ~ 0.3 0.3 0.3 1.0 15
execute as @s at @s if score @s itemage >= planttime itemage run setblock ~ ~.2 ~ minecraft:nether_wart replace
